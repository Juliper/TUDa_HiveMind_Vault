---
title: Chinesische Phrasen
aliases:
  - Chinesische Standardphrasen
  - Chinese Phrases
tags:
  - chinesisch
  - sprache
...
| 明星    | míngxīng     | Star, Berühmtheit         |
| 导游    | dǎoyóu       | Reiseleiter/in            |
| 律师    | lǜshī        | Anwalt / Anwältin         |
| 厨师    | chúshī       | Koch / Köchin             |
| 秘书    | mìshū        | Sekretär/in               |
| 工程师   | gōngchéngshī | Ingenieur/in              |
| 服务员   | fúwùyuán     | Kellner/in, Servicekraft  |
| 理发师   | lǐfàshī      | Friseur/in                |
| 修理工   | xiūlǐgōng    | Handwerker/in, Mechaniker |
| 医院    | yīyuàn       | Krankenhaus               |
| 学校    | xuéxiào      | Schule                    |
| 室内    | shìnèi       | drinnen, innen            |
| 室外    | shìwài       | draußen, außen            |
| 工作    | gōngzuò      | Arbeit, Job               |
| 照片    | zhàopiàn     | Foto                      |
| 名字    | míngzi       | Name                      |
| 字     | zì           | Schriftzeichen            |
| 国     | guó          | Land, Staat               |
...
| Hànzì | Pīnyīn | Deutsch |
| ----- | ------ | ------- |
| 高兴 | gāoxìng | froh, glücklich |
| 好 | hǎo | gut |
| 安 | ān | sicher, friedlich |
...
| 做 | zuò | machen, tun |
| 工作 | gōngzuò | arbeiten |
| 叫 | jiào | heißen, nennen |
| 是 | shì | sein |
| 住 | zhù | wohnen |
| 在 | zài | sein in / an |
| 认识 | rènshi | kennen |
| 知道 | zhīdào | wissen |
| 姓 | xìng | heißen (Nachname) |
...
| ----- | ------ | ------- |
| 和 | hé | und |
| 但是 / 但 | dànshì / dàn | aber |

## Partikel

| Hànzì | Pīnyīn | Deutsch |
| ----- | ------ | ------- |
| 的 | de | Genitiv-Partikel |
| 吗 | ma | Fragesatz-Partikel |
| 呢 | ne | Rückfrage-Partikel |
...
| 我叫丁云，我是学校的老师。 | Wǒ jiào Dīng Yún, wǒ shì xuéxiào de lǎoshī. | Ich heiße Ding Yun, ich bin Lehrer/in an einer Schule.          |
| 学生都叫我丁老师。     | Xuésheng dōu jiào wǒ Dīng lǎoshī.           | Die Schüler nennen mich alle Lehrer Ding.                       |
| 我哥哥也是老师，他在英国。 | Wǒ gēge yě shì lǎoshī, tā zài Yīngguó.      | Mein älterer Bruder ist auch Lehrer, er ist in England.         |
| 我姐姐在法国，她是记者。  | Wǒ jiějie zài Fǎguó, tā shì jìzhě.          | Meine ältere Schwester ist in Frankreich, sie ist Journalistin. |
...
|---|---|---|
| 先生 | xiānsheng | Herr |
| 女士 | nǚshì | Frau (formell) |
| 太太 | tàitai | Frau (verheiratet) |
| 老师 | lǎoshī | Lehrer/in |
| 同学 | tóngxué | Kommilitone/in / Mitschüler/in |

## Nützliche Kurzphrasen

| Hànzì | Pīnyīn | Deutsch |
|---|---|---|
| 是 | shì | Ja / Sein |
| 不是 | bú shì | Nein / Nicht sein |
| 好 | hǎo | Gut / OK |
| 好的 | hǎo de | In Ordnung |
| 不好 | bù hǎo | Nicht gut |
| 对 | duì | Richtig / Stimmt |
| 不对 | bú duì | Falsch / Stimmt nicht |

> [!NOTE] Tipp
> Die Partikel 吗 (ma) am Satzende verwandelt eine Aussage in eine Ja/Nein-Frage:
