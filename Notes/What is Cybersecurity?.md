...
2. Positive goals (what Alice can do) are easier to verify than negative ones (what Eve can accomplish)
3. Security is only as strong as the weakest link
4. Threats evolve: security requires iterative modelling (design, update, deploy, repeat)
5. Security updates are often slowly and selectively deployed, leaving some systems perpetually vulnerable
...
- [[CIA Triad]]: the security goals that structure cybersecurity
- [[Secure by Design]]: how to build systems secure from the ground up
- [[Threat Modelling]]: structured process to identify risks
